...
insert into `Users` (`userId`, `userName`, `userBirth`, `userGender`, `userHp`, `userPoint`, `userLevel`, `userAddr`, `userRegDate`) values ('user2', '계백', '1976-06-11', 'M', '010-1102-1975', '1000', '1', '서울', '2022-01-10 10:50:12');
...
insert into `OrderItems` values ('12', '22010510031', '100110', '170115', '12', '1');
