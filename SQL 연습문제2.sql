...
CREATE TABLE `bank_customer` (
    ...
    `c_dist` TINYINT DEFAULT 0 NOT NULL,
...
insert into `bank_customer` values ('220-82-52237', '㈜한국전산', '2', '02-134-1045', '서울시 강서구');
insert into `bank_customer` values ('361-22-42687', '㈜정보산업', '2', '031-563-1253', '경기도 광명시');
...
insert into `bank_account` values ('101-12-1005', 'S3', '주택청약예금', '941127-1000006', '720800', '2012-10-15');
insert into `bank_account` values ('101-12-1004', 'L1', '고객신용대출', '910912-2000005', '1200500', '2009-08-25');
insert into `bank_account` values ('101-12-1006', 'L2', '예금담보대출', '730423-1000001', '25000', '2013-12-11');
insert into `bank_account` values ('101-12-1007', 'L3', '주택담보대출', '750210-1000002', '2700000', '2020-09-23');
...
FROM
    bank_transaction AS a
        JOIN
    bank_account AS b ON a.t_a_no = b.a_no
        JOIN
    bank_customer AS c ON b.a_c_no = c.c_no
WHERE
    t_dist IN (1 , 2) AND c_dist = 1
GROUP BY c_no
