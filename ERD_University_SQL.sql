...
insert into `Students` values ('20111014', '11', 'P11104', '원빈', '660912-1234567', '010-2104-6609', 'one@daum.net', '대구');
...
insert into `Professors` values ('P31104', '31', '신사임당', '711127-1234567', '010-6101-1972', 'kimys@hg.ac.kr', '서울');
