...
insert into `Departments` values ('107', '흉부회과', '류성룡', '051-123-0107');
...
insert into `Doctors` values ('D101102', '계백', '1975-06-11', 'M', '101', '전문의', '010-1101-1975', 'gaeback@bw.com');
...
insert into `Patients` values ('P108101', 'D108101', 'N108101', '김연아', '651021-1234567', 'F', '대구', '010-5101-6510', 'yuna@daum.net', 'yuna@daum.net');
...
insert into `Nurses` values ('N102103', '박명수', '1976-02-21', 'M', '102', '주임', '010-2101-7905', 'park@bw.com');
